...
class BatTri extends BaseWatchFace {
	...
	override function preview():Void {
		Wasp.system.bar.displayClock = false;
		draw(true);
	}

	function draw(redraw:Bool = false):Void {
		var draw = Watch.drawable;
		var hi = Wasp.system.theme.bright;
		var mid = Wasp.system.theme.mid;
		var ui = Wasp.system.theme.ui;
